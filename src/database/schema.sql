...
Garoto de ouro da natação, Lukas Blomqvist é capitão da equipe da universidade e campeão mundial, e conquistou tudo isso com muita disciplina.E assim que ele consegue medalhas e quebra recordes: com foco total a cada braçada.
...
E um clichê tão grande que o coração dela quase não aguenta: homem mais velho e mulher mais nova, empresário rico e estudante falida, melhor amigo do irmão e a garota na qual ele nunca reparou.
...
Enquanto isso, Maggie está desfrutando da nova etapa de sua vida, embora ainda sinta algum ressentimento por tudo o que aconteceu. Após tantos anos vivendo uma relação já estável - e morna - com Ridge, Maggie não consegue prever o que a aguarda. A insegurança com relação a sua doença, o desejo de independência e a ânsia de viver novas e empolgantes experiências e nesse meio que entra Jake, o rapaz que a ajudou a cumprir o primeiro item em sua lista de coisas para fazer: pular de paraquedas. Ele está tão interessado nela quanto ela nele, mas Maggie arriscará viver um novo relacionamento e deixar o passado para trás?
...
('E Assim Que Acaba', 'Nesse livro, Colleen Hoover nos apresenta Lily, uma jovem que se mudou de uma cidadezinha do Maine para Boston, se formou em marketing e abriu a própria floricultura. E é em um dos terraços de Boston que ela conhece Ryle, um neurocirurgião confiante, teimoso e talvez até um pouco arrogante, com uma grande aversão a relacionamentos, mas que se sente muito atraído por ela.
...
E assim que acaba é uma narrativa poderosa sobre a força necessária para fazer as escolhas certas nas situações mais difíceis. Considerada a obra mais pessoal de Hoover, o livro aborda sem medo alguns tabus da sociedade para explorar a complexidade das relações tóxicas, e como o amor e o abuso muitas vezes coexistem em uma confusão de sentimentos.', 2, '2018-01-18', 368, 'https://m.media-amazon.com/images/I/51i7kH+rh9L._SY445_SX342_.jpg', 'Português', 'Romance'),
('E Assim Que Começa', 'Lily Bloom continua administrando uma floricultura. Seu ex-marido abusivo, Ryle Kincaid, ainda é um    cirurgião. Mas agora os dois estão oficialmente divorciados e dividem a guarda da filha, Emerson.
...
('O Senhor dos Anéis: A Sociedade do Anel', 'Primeiro volume da trilogia, lançado em 1954. A história acompanha Frodo Bolseiro em sua missão de destruir o Um Anel, unindo-se à Sociedade do Anel formada por hobbits, homens, um elfo, um anão e Gandalf.', 10, '1954-07-29', 576, 'https://m.media-amazon.com/images/I/91zU0TtLZPL._SY466_.jpg', 'Português', 'Fantasia'),

('O Senhor dos Anéis: As Duas Torres', 'Segundo volume da trilogia, publicado em 1954. A narrativa se divide entre a jornada de Frodo e Sam rumo a Mordor e as batalhas enfrentadas pelos demais membros da Sociedade.', 10, '1954-11-11', 464, 'https://m.media-amazon.com/images/I/81dQwQlmAXL._SY466_.jpg', 'Português', 'Fantasia'),

('O Senhor dos Anéis: O Retorno do Rei', 'Terceiro e último volume da trilogia, lançado em 1955. A guerra pela Terra-média chega ao auge, enquanto Frodo e Sam tentam destruir o Um Anel em Mordor.', 10, '1955-10-20', 528, 'https://m.media-amazon.com/images/I/81X7EXg9f2L._SY466_.jpg', 'Português', 'Fantasia'),

('O Silmarillion', 'Publicado postumamente em 1977, reúne mitos e lendas da Terra-média, narrando a criação do mundo, a luta entre os Valar e Morgoth e as origens de elfos e homens.', 10, '1977-09-15', 496, 'https://m.media-amazon.com/images/I/81i2eQEszQL._SY466_.jpg', 'Português', 'Fantasia');
